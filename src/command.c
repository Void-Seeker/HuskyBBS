...
const   unsigned char   echo_off    [] = { IAC, WILL, TELOPT_ECHO, '\0' };
const   unsigned char   echo_on     [] = { IAC, WONT, TELOPT_ECHO, '\0' };
...
{
    write_to_buffer(usr->desc, (char*)echo_off, 0);
...
void edit_pwd_old( USER_DATA *usr, char *argument )
{
    ...
    if (argument[0] == '\0')
    {
        ...
        write_to_buffer(usr->desc, (char*)echo_on, 0);
